...
#
    ...
    def forward(self, logits, code_logits, labels, 
        ...
        #attr contra L_pointwise 
        new1_loss = self.attr_contra_loss(new1, attr_data, labels, pos_th = 0.9)
        new1_w = -0.1
